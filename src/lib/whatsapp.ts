...
export const WA_MESSAGES = {
  ...
  pricingFull: "Hi! I'd like the Full Setup Package (₦500,000) — the complete company incorporation with premium branding and a corporate bank account. How do I proceed?",
