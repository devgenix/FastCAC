...
export default function BlogIndexPage() {
  return (
    <div className="min-h-screen bg-surface">
      {/* Hero Section */}
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 bg-surface-container/30 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
        <div className="max-w-[1320px] section-px mx-auto relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="text-5xl lg:text-8xl font-headline font-black italic tracking-tighter leading-[1] mb-8">
