...
// Icons that mimic Lucide React behavior (SVG-based)
...
export const Rocket = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.4 1.26-1.26 1.81-2.15L13 13l2.5-2.5L13 8l-2.5 2.5L8 13c-.89.55-1.75 1.1-2.15 1.81z" />
    <path d="m2 22 3-3" />
    <path d="M15 11.5L16.5 13l4.5-4s1.75-2.25 0-4c-1.75-1.75-4 0-4 0l-4 4.5 1.5 1.5" />
